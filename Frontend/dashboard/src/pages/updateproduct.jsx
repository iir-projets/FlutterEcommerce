...
const Updateproduct = () => {
    ...
    const handleAddArticle = async () => {
        try {
            ...
            // Use productId to update the existing product
            const response = await axios.put(`${backendUrl}/updateArticle/${productId}`, formData, {
                headers: {
    ...
    return (
        <>
            <div>
                <button type="button" className="btn btn-info" onClick={() => handleEdit(productId)}><FaEdit /></button>
            </div>
            <Modal
                show={show}
                onHide={handleClose}
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>update the Article</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <form>
                        <div className="mb-3">
